        ...
        <>
            ...
            <div className="max-w-3xl  mx-auto py-8 px-4  flex">
                <div className="w-full">
                    <h1 className="text-2xl text-center font-serif font-bold mb-4">INPUT HUB</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 pt-12">
                        <div>
                            <label htmlFor="name" className="block font-serif text-lg mb-1">Name</label>
                            <input
                                type="text"
                                id="name"
                                name="name"
                        ...
                        <div>
                            <label htmlFor="email" className="block font-serif text-lg mb-1">Email</label>
                            <input
                                type="email"
                                id="email"
                                name="email"
                        ...
                        <div>
                            <label htmlFor="feedback" className="block font-serif text-lg mb-4">Feedback</label>
                            <textarea
                                id="feedback"
                                name="feedback"
                                rows={4}
                        ...
                        <button type="submit" className="bg-[#54BD95] hover:bg-green-300 font-serif text-white py-2 px-7 rounded-3xl text-xl transition duration-300">Submit</button>
                    </form>
                </div>
